        ...
        it('should succeed on correct criteria by id', () =>
            artistComment.find({ id: comment2.id })
                .then(comments => {
                    ...
                    expect(date.toString()).toBe(comment2.date.toISOString())
                })
        )
        ...
        it('should succeed on correct criteria by artist id', () =>
            artistComment.find({ artistId: comment2.artistId })
                .then(comments => {
                    ...
                    expect(_comment.date.toString()).toBe(comment2.date.toISOString())
                    ...
                    expect(_comment2.date.toString()).toBe(comment4.date.toISOString())
                })
        )
    })
})